...
rem adb shell logcat | grep -E "AndroidRuntime|tangxinlou debug"
rem adb shell logcat | grep -E "AndroidRuntime|BluetoothFragment|GattConnectionImpl"
adb shell logcat | grep -E "AndroidRuntime|BluetoothFragment|GattConnectionImpl|WifiP2pGoMgr"
